/*
 * @maxim/dsh-client-ui-schedule-tab — client (browser) half.
 *
...
window.__ModuleLoader__.load({
	id: "@maxim/dsh-client-ui-schedule-tab",
	factory: (require) => {
		var module = { exports: {} };
		...
		const tagId = "@maxim/dsh-client-ui-schedule-tab/SchedulePanel.module.css";
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + tagId + '"]') === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@maxim/dsh-client-ui-schedule-tab";
